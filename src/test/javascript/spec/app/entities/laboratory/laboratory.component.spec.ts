...
import { LaboratoryComponent } from 'app/entities/laboratory/laboratory.component';
...
describe('Component Tests', () => {
    describe('Laboratory Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.laboratories[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
