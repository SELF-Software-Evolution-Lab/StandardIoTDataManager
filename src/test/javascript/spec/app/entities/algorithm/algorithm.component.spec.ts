...
import { AlgorithmComponent } from 'app/entities/algorithm/algorithm.component';
...
describe('Component Tests', () => {
    describe('Algorithm Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.algorithms[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
