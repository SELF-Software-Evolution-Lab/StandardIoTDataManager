...
import { TargetSystemComponent } from 'app/entities/target-system/target-system.component';
...
describe('Component Tests', () => {
    describe('TargetSystem Management Component', () => {
        let comp: TargetSystemComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TargetSystemComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.targetSystems[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
