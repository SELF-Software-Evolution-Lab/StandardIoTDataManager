...
describe('Component Tests', () => {
    describe('Sampling Management Component', () => {
        let comp: SamplingComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SamplingComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.samplings[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
