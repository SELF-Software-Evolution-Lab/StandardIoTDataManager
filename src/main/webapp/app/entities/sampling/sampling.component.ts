...
export class SamplingComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.samplingService
            ...
            .subscribe(
                (res: HttpResponse<ISampling[]>) => this.paginateSamplings(res.body, res.headers),
    ...
    ngOnInit() {
        ...
        this.registerChangeInSamplings();
    }
    ...
    registerChangeInSamplings() {
        this.eventSubscriber = this.eventManager.subscribe('samplingListModification', response => this.loadAll());
    }
