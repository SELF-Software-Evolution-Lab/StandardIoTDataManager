...
@Component({
    ...
    templateUrl: './mapreduce-report.component.html'
})
export class MapreduceReportComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/batch-task/mapreduce-report'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
